...
import { MapPin, Phone, Mail, Clock, Send, CheckCircle, AlertCircle, Package, Truck, Plane, Ship } from 'lucide-react'
  ...
  const faqs = [
    {
      ...
      answer: 'Most quotes are provided within 2-4 hours for standard shipments. Complex or specialized cargo may require 24-48 hours for accurate pricing.'
    },
    {
      question: 'What information do I need for a quote?',
      answer: 'We need origin and destination addresses, cargo dimensions and weight, commodity type, and preferred service level (standard, expedited, or express).'
    },
    {
      question: 'Do you handle hazardous materials?',
      answer: 'Yes, we are certified to handle hazardous materials and dangerous goods with proper documentation and compliance measures.'
    },
    {
      question: 'What are your payment terms?',
      answer: 'We offer flexible payment terms including credit accounts for established customers. Standard terms are net 30 days from invoice date.'
    },
    {
      question: 'Can you provide cargo insurance?',
      answer: 'Yes, we offer comprehensive cargo insurance coverage through leading underwriters at competitive rates.'
    },
    {
      question: 'How do I track my shipment?',
      answer: 'You can track shipments 24/7 through our online portal, mobile app, or by calling our customer service team.'
    }
  ]
          ...
          <div className="text-center">
            ...
            >
              ...
              <p className="text-xl text-slate-200 max-w-3xl mx-auto">
                Ready to streamline your logistics? Our experts are here to help you find 
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            >
              ...
              <p className="text-slate-600 mb-4">Speak with our logistics experts 24/7</p>
              <a href="tel:+13105550123" className="text-2xl font-bold text-navy-600 hover:text-navy-700 transition-colors duration-200">
                +1 (310) 555-0123
              </a>
            ...
            >
              ...
              <p className="text-slate-600 mb-4">Get detailed responses within 2 hours</p>
              <a href="mailto:info@globallogisticspro.com" className="text-lg font-semibold text-navy-600 hover:text-navy-700 transition-colors duration-200">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-4">Visit Us</h3>
              <p className="text-slate-600 mb-4">Schedule a consultation at our office</p>
              ...
              >
                <div className="mb-8">
                  <h2 className="text-2xl font-bold text-slate-900 mb-2">
                    {activeTab === 'quote' ? 'Get Your Free Quote' : 'Send Us a Message'}
                  </h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <option value="emergency">Emergency (30 minutes)</option>
                        </select>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <label htmlFor="privacy" className="text-sm text-slate-600">
                      I agree to the <a href="/privacy" className="text-navy-600 hover:text-navy-700">Privacy Policy</a> and 
                      <a href="/terms" className="text-navy-600 hover:text-navy-700">Terms of Service</a>
                    </label>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    >
                      {isSubmitting ? (
                        ...
                        <>
                          <span>{activeTab === 'quote' ? 'Get Free Quote' : 'Send Message'}</span>
          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                With offices strategically located near major ports and transportation hubs, 
                we're always close to where you need us.
              </p>
            </motion.div>
          </div>
              ...
              >
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <a href={`tel:${office.phone}`} className="text-navy-600 hover:text-navy-700 font-medium">
                      {office.phone}
                    </a>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <a href={`mailto:${office.email}`} className="text-navy-600 hover:text-navy-700">
                      {office.email}
                    </a>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="text-slate-700 font-medium">{office.hours}</div>
                      <div className="text-sm text-slate-500">{office.timezone}</div>
                    </div>
                  </div>
                </div>
