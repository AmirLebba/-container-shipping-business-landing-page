  ...
  const testimonials = [
    {
      ...
      content: 'GlobalLogistics Pro has been our trusted partner for over 5 years. Their expertise in customs clearance and attention to detail has saved us countless hours and significantly reduced our shipping costs. The real-time tracking system gives us complete visibility of our supply chain.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'The team at GlobalLogistics Pro understands the urgency of our just-in-time manufacturing requirements. Their express customs clearance service has been invaluable in keeping our production lines running smoothly. Highly recommended for any automotive business.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'Handling perishable goods requires precision and speed. GlobalLogistics Pro\'s temperature-controlled shipping solutions and expert documentation services have been crucial to our success. Their 24/7 support team is always responsive and professional.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'As a fast-growing fashion brand, we needed a logistics partner who could scale with us. GlobalLogistics Pro not only handles our seasonal volume spikes flawlessly but also provides strategic advice on optimizing our supply chain for cost efficiency.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'The complexity of our heavy machinery imports was overwhelming until we partnered with GlobalLogistics Pro. Their team handled everything from specialized equipment permits to coordination with multiple agencies. Truly exceptional service.',
      rating: 5,
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <p className="text-xl  max-w-3xl mx-auto">
              ...
              working with GlobalLogistics Pro.
            </p>
          </motion.div>
        </div>
