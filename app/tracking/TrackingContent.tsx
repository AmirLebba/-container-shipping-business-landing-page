...
import { Phone, Mail } from "lucide-react"; // add this at the top
import {
  Package,
  MapPin,
  Clock,
...
const sampleShipments: Record<string, Shipment> = {
  GLP2024001: {
    id: "GLP2024001",
    status: "in-transit",
    origin: "Shanghai, CN",
                ...
                >
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-4 bg-slate-50 rounded-lg">
                      ...
                      <p className="text-sm text-slate-600 mb-2">
                        Send us your questions and we&apos;ll respond within 2
                        hours.
                      </p>
                      <a
                        href="mailto:support@globallogisticspro.com"
                        className="text-navy-600 hover:text-navy-700 font-medium"
                      >
                    ...
                    <div className="p-4 bg-slate-50 rounded-lg">
                      ...
                      <p className="text-sm text-slate-600">
                        {formatTime(shipmentData.lastUpdate.split("T")[1])} on{" "}
                        {formatDate(shipmentData.lastUpdate)}
                      </p>
                    </div>
                  </div>
                </motion.div>
